...
labels_v2 = ["අ", "ආ", "ඇ", "ඉ", "ඊ", "උ", "ඌ", "එ", "ඒ", "ක්", "ග්", "ජ්", "ට්", "ද්", "ප්", "බ්",
             "ස්",
             "ය්",
             "හ්",
             "ව්"]
...
while True:
    ...
    if hands:
        ...
        predictions_array.append(labels_v2[index])  # Save the prediction in an array

        cv2.putText(imgOutput, labels[index], (x, y - 20), cv2.FONT_HERSHEY_COMPLEX, 1,
                    (255,
                     0,
                     255),
                    1)
...
# Print the words based on the predictions
